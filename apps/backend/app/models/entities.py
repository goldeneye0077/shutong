...
class TicketReminder(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "ticket_reminders"

    ticket_id: Mapped[str] = mapped_column(ForeignKey("tickets.id"), nullable=False)
    message: Mapped[str] = mapped_column(Text, nullable=False)
    reminded_to: Mapped[str | None] = mapped_column(String(100))
...
class LedgerItem(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    imported_by_id: Mapped[str | None] = mapped_column(ForeignKey("users.id"))
